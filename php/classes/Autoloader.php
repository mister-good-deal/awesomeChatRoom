...
class Autoloader
{
     ...
     * @param      bool    $prepend  If true, prepend the base directory to the stack instead of appending it; this
     ...
     *
     * @return     mixed   Boolean false if no mapped file can be loaded, or the name of the mapped file that was
     *                     loaded.
     */
